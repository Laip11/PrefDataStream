...
openrlhf.cli.train_kto \
   --save_path /volume/pt-train/users/wzhang/ghchen/laip/saves/Llama-3-Base-8B-SFT/Llama-3-Base-8B-SFT_kto_ours \
   --save_steps -1 \
   --logging_steps 1 \
   --eval_steps -1 \
   ...
   --zero_stage 3 \
   --learning_rate 5e-7 \
   --dataset /volume/pt-train/users/wzhang/ghchen/laip/datasets/Llama-3-Base-8B-SFT_flip_20_ad_avg_logprobs_gap_high_30k_data \
